#!/usr/bin/env node
// NAME-RESERVATION STUB for the RETIRED `sparkbtcbot-reveal-mnemonic` command.
//
// `sparkbtcbot-reveal-mnemonic` was a bin in sparkbtcbot-skill 0.4.x-0.5.x. 0.6.0 collapsed the five
// per-command bins into one dispatcher, so the command is now `sparkbtcbot reveal-mnemonic`.
...
process.stderr.write(
  "sparkbtcbot-reveal-mnemonic: this command was retired in sparkbtcbot-skill 0.6.0.\n" +
  "\n" +
