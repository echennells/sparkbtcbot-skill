#!/usr/bin/env node
// NAME-RESERVATION STUB for the RETIRED `sparkbtcbot-set-policy` command.
//
// `sparkbtcbot-set-policy` was a bin in sparkbtcbot-skill 0.4.x-0.5.x. 0.6.0 collapsed the five
// per-command bins into one dispatcher, so the command is now `sparkbtcbot set-policy`.
...
process.stderr.write(
  "sparkbtcbot-set-policy: this command was retired in sparkbtcbot-skill 0.6.0.\n" +
  "\n" +
