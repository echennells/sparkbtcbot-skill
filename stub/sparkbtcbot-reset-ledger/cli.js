#!/usr/bin/env node
// NAME-RESERVATION STUB for the RETIRED `sparkbtcbot-reset-ledger` command.
//
// `sparkbtcbot-reset-ledger` was a bin in sparkbtcbot-skill 0.4.x-0.5.x. 0.6.0 collapsed the five
// per-command bins into one dispatcher, so the command is now `sparkbtcbot reset-ledger`.
...
process.stderr.write(
  "sparkbtcbot-reset-ledger: this command was retired in sparkbtcbot-skill 0.6.0.\n" +
  "\n" +
  ...
  "  npm exec --no -- sparkbtcbot reset-ledger\n" +
  "\n" +
