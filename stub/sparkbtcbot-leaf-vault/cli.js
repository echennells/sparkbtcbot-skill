#!/usr/bin/env node
// NAME-RESERVATION STUB for the RETIRED `sparkbtcbot-leaf-vault` command.
//
// `sparkbtcbot-leaf-vault` was a bin in sparkbtcbot-skill 0.4.x-0.5.x. 0.6.0 collapsed the five
// per-command bins into one dispatcher, so the command is now `sparkbtcbot leaf-vault`.
...
process.stderr.write(
  "sparkbtcbot-leaf-vault: this command was retired in sparkbtcbot-skill 0.6.0.\n" +
  "\n" +
  ...
  "  npm exec --no -- sparkbtcbot leaf-vault\n" +
  "\n" +
